...
enum UdmfStaticSpecial
{
   ...
   EV_STATIC_TRANSFER_HEIGHTS = 209,
...
static void InitLineMapping()
{
   ...
   gMapping[EV_STATIC_FRICTION_TRANSFER] = {0, {0, 0, 0, 0, 0}, 0, &Converter::SetFriction};
   ...
   gMapping[EV_STATIC_PUSHPULL_CONTROL] = {};   // TODO
   gMapping[EV_STATIC_PUSHPULL_CONTROL_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_ACCEL_CEILING] = {};
   gMapping[EV_STATIC_SCROLL_ACCEL_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_ACCEL_WALL] = {};
   gMapping[EV_STATIC_SCROLL_BY_OFFSETS] = {};
   gMapping[EV_STATIC_SCROLL_CARRY_ACCEL_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_CARRY_DISPLACE_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_CARRY_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_CEILING] = {};
   gMapping[EV_STATIC_SCROLL_CEILING_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_DISPLACE_CEILING] = {};
   gMapping[EV_STATIC_SCROLL_DISPLACE_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_DISPLACE_WALL] = {};
   gMapping[EV_STATIC_SCROLL_DOWN_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_FLOOR] = {};
   gMapping[EV_STATIC_SCROLL_FLOOR_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_LEFT_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_LINE_DOWN] = {};
   gMapping[EV_STATIC_SCROLL_LINE_DOWN_FAST] = {};
   gMapping[EV_STATIC_SCROLL_LINE_LEFT] = {};
   gMapping[EV_STATIC_SCROLL_LINE_RIGHT] = {};
   gMapping[EV_STATIC_SCROLL_LINE_UP] = {};
   gMapping[EV_STATIC_SCROLL_RIGHT_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_UP_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_WALL_PARAM] = {};
   gMapping[EV_STATIC_SCROLL_WALL_WITH] = {};
   gMapping[EV_STATIC_SKY_TRANSFER] = {};
   gMapping[EV_STATIC_SKY_TRANSFER_FLIPPED] = {};
   gMapping[EV_STATIC_SLOPE_BACKFLOOR_FRONTCEILING] = {};
   gMapping[EV_STATIC_SLOPE_BSEC_CEILING] = {};
   gMapping[EV_STATIC_SLOPE_BSEC_FLOOR] = {};
   gMapping[EV_STATIC_SLOPE_BSEC_FLOOR_CEILING] = {};
   gMapping[EV_STATIC_SLOPE_FRONTCEILING_TAG] = {};
   gMapping[EV_STATIC_SLOPE_FRONTFLOORCEILING_TAG] = {};
   gMapping[EV_STATIC_SLOPE_FRONTFLOOR_BACKCEILING] = {};
   gMapping[EV_STATIC_SLOPE_FRONTFLOOR_TAG] = {};
   gMapping[EV_STATIC_SLOPE_FSEC_CEILING] = {};
   gMapping[EV_STATIC_SLOPE_FSEC_FLOOR] = {};
   gMapping[EV_STATIC_SLOPE_FSEC_FLOOR_CEILING] = {};
   gMapping[EV_STATIC_SLOPE_PARAM] = {};
   gMapping[EV_STATIC_SLOPE_PARAM_TAG] = {};
   gMapping[EV_STATIC_TRANSFER_HEIGHTS] = {};
   gMapping[EV_STATIC_TRANSLUCENT] = {};
   gMapping[EV_STATIC_WIND_CONTROL] = {};
   gMapping[EV_STATIC_WIND_CONTROL_PARAM] = {};
}
